...
console.log("Tomorrow it will be " + weatherData.forecast[0].temperature + " degrees and" + weatherData.forecast[0].conditions);
console.log("The next day we will see "+ weatherData.forecast[1].conditions + " with a temperature of " + weatherData.forecast[1].temperature);
